...
namespace ScpSurfaceRework
{
    public class Config : IConfig
    {
        ...
        public float Scp173Hs { get; set; } = 1500;
        ...
        public float Scp049Hs { get; set; } = 700;
        ...
        [Description("The amount of HS SCP-049 will get for a successful revive after warhead was detonated. Default: 100")]
        public float Scp049BonusHs { get; set; } = 100;
        ...
        public float Scp096Hs { get; set; } = 500;
        ...
        public float Scp0492Hs { get; set; } = -1;
        ...
        public float Scp939Hs { get; set; } = 800;
